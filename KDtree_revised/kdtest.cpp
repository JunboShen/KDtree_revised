...
int main()
{
    ...
    //test
    cout << set[0].number[0] << set[0].number[1] << "\n";
    cout << set[1].number[0] << set[1].number[1] << "\n";
    cout << set[2].number[0] << set[2].number[1] << "\n";
    cout << set[3].number[0] << set[3].number[1] << "\n";
    cout << set[4].number[0] << set[4].number[1] << "\n";
    cout << set[5].number[0] << set[5].number[1] << "\n";
